  ...
  render(){
    ...
    return(
      <div className="div-principalMenuCentral">
        ...
        <a href="/">
          <img className="img-menuCentral-header" src="http://tequila.tecmm.edu.mx/imagenes/header.jpg"/>
        </a>
        <img className="img-menuCentral-nombre" src="http://tequila.tecmm.edu.mx/imagenes/tequila.png"/>
